...
//          Thread.sleep(5000);
        ...
        //  turnOnLocation.click(); 
  		...
  		driver.findElement(AppiumBy.androidUIAutomator(
  			...
  			WebElement SubmitButton = driver.findElement(AppiumBy.androidUIAutomator("new UiSelector().description(\"Submit\")"));
  			SubmitButton.click();

  			


  	  		//WebElement Message = driver.findElement(AppiumBy.androidUIAutomator("new UiSelector().description(\"Message\")"));
  	  		//Message.click();
...
//  			WebElement toastMessage = wait.until(ExpectedConditions.presenceOfElementLocated(8
//  			    By.xpath("//android.widget.Toast")));
//
//  			// Print the toast message
//  			System.out.println("Toast message: " + toastMessage.getAttribute("name"));


  			////new UiSelector().description("Message")
  			/////new UiSelector().description("Listing added successfully")
  			////new UiSelector().description("Okay")
	}
