...
//
//		WebElement TourApp = wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(AppiumBy.accessibilityId("Predicted app: Tour Palestine"))));
//		TourApp.click();
        
     // This will find the 5th instance of the element with class "android.view.View"
...
//          Thread.sleep(5000);
        ...
        //  WebElement mainbutton3 = wait.until(ExpectedConditions.elementToBeClickable(AppiumBy.className("android.widget.Button")));
          WebElement mainbutton4 = wait.until(ExpectedConditions.elementToBeClickable(AppiumBy.androidUIAutomator("new UiSelector().className(\"android.widget.Button\")")));
...
//          
        ...
        ///  WebElement Name = wait.until(ExpectedConditions.presenceOfElementLocated(
        	...
        	///actions.moveToElement(Name).click().sendKeys("Hotel Name").perform();
        	///Thread.sleep(5000);
        	
        	WebElement textBox = driver.findElement(AppiumBy.androidUIAutomator(
        		    "new UiSelector().className(\"android.widget.EditText\").instance(0)"));
        	Actions actions2 = new Actions(driver);

        		actions2.moveToElement(textBox).click().sendKeys("Name").perform();
            	Thread.sleep(5000);
...
//        	 City.click();
//
//         	actions.moveToElement(City).click();
//         	
