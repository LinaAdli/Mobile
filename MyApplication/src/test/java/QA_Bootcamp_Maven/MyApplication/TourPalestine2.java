...
//      		Thread.sleep(5000);
  		//driver.findElement(AppiumBy.androidUIAutomator(
  		//	    "new UiScrollable(new UiSelector().scrollable(true)).scrollIntoView(new UiSelector().bounds(\"[501,1198][621,1290]\") )"));
  		driver.findElement(AppiumBy.androidUIAutomator(
  			    "new UiScrollable(new UiSelector().scrollable(true)).scrollIntoView(new UiSelector().description(\"Submit\"))"));
  			// Now interact with the image
  		int startX = 501;
  		int startY = 1198;
  		int endX = 621;
  		int endY = 1290;
  		...
  		// Perform a tap action at the center of the image
  		...
  		driver.findElement(AppiumBy.androidUIAutomator(
  			...
  			// Now that the button is visible, find and click it
